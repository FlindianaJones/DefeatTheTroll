...
public class ActivityArtBindingImpl extends ActivityArtBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.continue_art_btn, 2);
    }
    // views
    @NonNull
    ...
    public ActivityArtBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }
    private ActivityArtBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        java.lang.String textView8AndroidStringArtPromptTxtSelectedBeastSelectedBeast = null;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
                ...
                // read @android:string/art_prompt_txt
                textView8AndroidStringArtPromptTxtSelectedBeastSelectedBeast = textView8.getResources().getString(R.string.art_prompt_txt, selectedBeastSelectedBeast);
        }
        // batch finished
        if ((dirtyFlags & 0x7L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.textView8, textView8AndroidStringArtPromptTxtSelectedBeastSelectedBeast);
        }
    }
