...
public class ActivityLoveBindingImpl extends ActivityLoveBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.find_love_btn, 2);
        sViewsWithIds.put(R.id.love_list, 3);
    }
    // views
    @NonNull
    ...
    public ActivityLoveBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private ActivityLoveBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (android.widget.Button) bindings[2]
            , (androidx.recyclerview.widget.RecyclerView) bindings[3]
            , (android.widget.TextView) bindings[1]
            );
        this.lovePrompt.setTag(null);
    ...
    protected void executeBindings() {
        ...
        java.lang.String lovePromptAndroidStringLovePromptSelectedBeastSelectedBeast = null;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
                ...
                // read @android:string/love_prompt
                lovePromptAndroidStringLovePromptSelectedBeastSelectedBeast = lovePrompt.getResources().getString(R.string.love_prompt, selectedBeastSelectedBeast);
        }
        // batch finished
        if ((dirtyFlags & 0x7L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.lovePrompt, lovePromptAndroidStringLovePromptSelectedBeastSelectedBeast);
        }
    }
